...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.comments$ = this.commentsService
            .getAll()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) { return (_this.loadingError = !res); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return (_this.searchValue ? Object(_shared_helpers__WEBPACK_IMPORTED_MODULE_5__["search"])(res, _this.searchValue) : res); }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["repeatWhen"])(function () { return _this.reload$; }));
        this.commentsService.added
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroyed$))
            .subscribe(function (value) { return _this.onAddComment(value); });
        this.commentsService.removed
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroyed$))
            .subscribe(function (value) { return _this.onRemoveComment(value); });
    };
    AppComponent.prototype.onSearch = function (value) {
        this.searchValue = value;
        this.onDataOutdated();
    };
    AppComponent.prototype.onAddComment = function (value) {
        var _this = this;
        this.commentsService
            .add(value.text, value.id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroyed$))
            .subscribe(function () { return _this.onDataOutdated(); });
    };
    AppComponent.prototype.onDataOutdated = function () {
        this.reload$.next();
    };
    AppComponent.prototype.onRemoveComment = function (id) {
        var _this = this;
        this.commentsService
            .remove(id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroyed$))
...
var modules = [_search_component_search_component_module__WEBPACK_IMPORTED_MODULE_0__["SearchComponentModule"]];
...
var SearchComponentComponent = /** @class */ (function () {
    function SearchComponentComponent(controlService) {
        this.controlService = controlService;
        this.placeholder = 'search';
        this.valueChanged = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.destroyed$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
    }
    Object.defineProperty(SearchComponentComponent.prototype, "formControl", {
        get: function () {
    ...
    SearchComponentComponent.prototype.ngOnDestroy = function () {
        this.destroyed$.next();
        this.destroyed$.complete();
    };
    ...
    SearchComponentComponent.prototype.doOnSearchValueChanges = function () {
        var _this = this;
    ...
    SearchComponentComponent.ctorParameters = function () { return [
...
var ControlService = /** @class */ (function () {
    ...
    ControlService.prototype.buildControl = function (control) {
...
var id = (_a = {},
    _a["id" /* id */] = "[0-9]+",
    _a["ref" /* ref */] = "[a-fA-F0-9]{8}-(?:[a-fA-F0-9]{4}-){3}[a-fA-F0-9]{12}",
    _a);
function createEscapedPath(url, withQueryParams) {
    if (withQueryParams === void 0) { withQueryParams = false; }
    var queryParams = withQueryParams ? '(?:\\?.*)?' : '';
    var escapedUrl;
    if (Object(lodash_es__WEBPACK_IMPORTED_MODULE_1__["isArray"])(url)) {
        escapedUrl = url
            .map(function (u, i) {
            return i === _constants_id_index__WEBPACK_IMPORTED_MODULE_2__["idIndex"] ? "/(" + id[u] + ")" : Object(lodash_es__WEBPACK_IMPORTED_MODULE_1__["escapeRegExp"])(u);
        })
            .join('');
    }
    else {
...
function finishOptions(options, _a) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _constants_id_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../constants/id-index */ "./src/app/core/mocks/constants/id-index.ts");
/* harmony import */ var _constants_request_bindings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../constants/request-bindings */ "./src/app/core/mocks/constants/request-bindings.ts");
...
function parseRequestUrl(url, utils) {
    ...
    _constants_request_bindings__WEBPACK_IMPORTED_MODULE_2__["requestBindings"].forEach(function (r) {
        var matchResult = url.match(r.path);
        if (matchResult) {
            request = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, parsed);
            request.collectionName = r.collectionName;
            request.id = matchResult[_constants_id_index__WEBPACK_IMPORTED_MODULE_1__["idIndex"]];
        }
    });
    return request;
}
...
function commentDeleteMethod(reqInfo) {
    return reqInfo.utils.createResponse$(function () {
        var db = reqInfo.utils.getDb();
        var comments = db[_enums__WEBPACK_IMPORTED_MODULE_1__["CollectionName"].comments];
...
var MockService = /** @class */ (function () {
    ...
    MockService.prototype.createDb = function (reqInfo) {
        var _a;
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])((_a = {},
            _a[_enums__WEBPACK_IMPORTED_MODULE_4__["CollectionName"].comments] = _constants__WEBPACK_IMPORTED_MODULE_3__["commentsMock"],
            _a));
    };
    MockService.prototype.delete = function (reqInfo) {
    ...
    MockService.prototype.post = function (reqInfo) {
        if (!reqInfo.collection) {
            return null;
        }
        // tslint:disable-next-line:no-small-switch
...
var CommentsComponent = /** @class */ (function () {
    ...
    CommentsComponent.prototype.onRemove = function (id) {
        this.commentsService.removed.next(id);
    };
    CommentsComponent.prototype.onSubmit = function (formValue, id) {
        this.commentsService.added.next({ text: formValue.text, id: id });
    };
...
var Comment = /** @class */ (function () {
    ...
    Comment.fromBackendFactory = function (obj) {
        return new Comment({
            text: obj.text,
            comments: obj.comments.map(function (comment) {
                return Comment.fromBackendFactory(comment);
            }),
            id: obj.id,
        });
    };
...
var CommentsService = /** @class */ (function () {
    ...
    CommentsService.prototype.add = function (value, id) {
        var body = {
            id: id,
            text: value,
        };
    ...
    CommentsService.prototype.getAll = function () {
        return this.httpClient
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.map(function (comment) { return _models__WEBPACK_IMPORTED_MODULE_7__["Comment"].fromBackendFactory(comment); }); }));
    };
...
var CommentFormComponent = /** @class */ (function () {
    function CommentFormComponent(formService) {
    ...
    Object.defineProperty(CommentFormComponent.prototype, "form", {
        get: function () {
    ...
    Object.defineProperty(CommentFormComponent.prototype, "invalid", {
        get: function () {
...
var CommentFormModule = /** @class */ (function () {
    function CommentFormModule() {
    }
...
var FormService = /** @class */ (function () {
    ...
    Object.defineProperty(FormService.prototype, "invalid", {
        get: function () {
    ...
    Object.defineProperty(FormService.prototype, "value", {
        get: function () {
    ...
    FormService.prototype.buildForm = function () {
        this._form = this._buildForm();
    };
    FormService.prototype._buildForm = function () {
        var _a;
        return this.fb.group((_a = {},
            _a[_enums__WEBPACK_IMPORTED_MODULE_3__["CommentFormKeys"].text] = [''],
            _a));
    };
...
var shared = [_comment_form_comment_form_module__WEBPACK_IMPORTED_MODULE_0__["CommentFormModule"]];
...
var common = [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["ReactiveFormsModule"]];
...
/* harmony import */ var _angular_material_button__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/material/button */ "./node_modules/@angular/material/esm5/button.es5.js");
...
var modules = [_common__WEBPACK_IMPORTED_MODULE_2__["common"], _material__WEBPACK_IMPORTED_MODULE_3__["material"]];
